new Vue({
    ...
    data: function () {
        return {
            ...
            headerTitle: 'CoinBanks App Store 安装',
            headerSubtitle: '如果您拥有非中国地区的 Apple ID，请直接使用该 ID 登录 App Store，下载 CoinBanks APP 即可。',
            ...
            tableAllData: [
                ...
                },
                {
                    ...
                    data: [
                        {
                            title: '登录成功后，会自动跳转至香港版的App Store点击App Store 下方搜索，然后在页面输入框搜索CoinBanks',
    ...
    methods: {
        handleDownload() {
            ...
            downloadEvent("coinbanks_store_ios_install_click");
        },
